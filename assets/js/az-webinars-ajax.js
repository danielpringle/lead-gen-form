jQuery(function($){
    ...
    function run_ajax(be_cats, page = 1) {
        ...
        console.log(be_cats);
        $.ajax({
            url: az_fetch_webinars.ajaxurl,
            type: 'post',
            data: { action: 'az_fetch_webinars', 
                    be_categories: be_cats,
                    page: page,
                    sort: jQuery('#az-events-sort-filter option:selected').val(),
    ...
    $(document).ready(function(){
        ...
        $('#az-events-sort-filter').change(function () {
